...
import com.zlikun.jee.api.UserApi;
...
public class UserApiController implements UserApi {
    ...
    public ResponseEntity<User> getUserByName(@ApiParam(value = "The name that needs to be fetched. ", required = true) @PathVariable("username") String username) {
        String accept = request.getHeader("Accept");
    ...
    public ResponseEntity<String> loginUser(@NotNull @ApiParam(value = "登录用户名", required = true) @Valid @RequestParam(value = "username", required = true) String username, @NotNull @ApiParam(value = "登录密码", required = true) @Valid @RequestParam(value = "password", required = true) String password) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/xml")) {
            try {
